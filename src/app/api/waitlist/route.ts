...
// Audience ID for the FunFit newsletter — set this in .env.local after creating it in Resend dashboard
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { error } = await resend.emails.send({
      from: "FunFit <onboarding@resend.dev>",
      to: email,
      subject: "Welcome to FunFit! 🧬",
          ...
          <tr>
            <td style="background-color:#12121a;border:1px solid #1e1e2e;border-radius:16px;padding:40px 32px;">
              ...
              <h1 style="color:#ffffff;font-size:28px;font-weight:800;text-align:center;margin:0 0 16px;line-height:1.2;">
                Hey ${name}, welcome to the FunFit community!
              </h1>
                    ...
                    <table cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td>
                          ...
                          <p style="color:#8a8a9a;font-size:13px;margin:4px 0 0;line-height:1.5;">Actionable tips to get the most out of FunFit and your health journey.</p>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td style="padding:32px 0;text-align:center;">
              <p style="color:#555555;font-size:12px;margin:0 0 8px;">
                You're receiving this because you subscribed to FunFit updates.
              </p>
              <p style="color:#444444;font-size:12px;margin:0;">
                &copy; ${new Date().getFullYear()} FunFit. All rights reserved.
              </p>
            </td>
          </tr>
