...
const faqs = [
  {
    question: "What is FunFit?",
    answer:
      "FunFit is an AI-powered health optimization app that combines food scanning, hormone tracking, gamified challenges, and a global leaderboard. It helps you understand and improve your health through science-backed insights and verified nutritional data.",
  },
  {
  ...
  {
    question: "How much does FunFit cost?",
    answer:
      "FunFit is a premium subscription app. A subscription is required to access all features including the AI food scanner, hormone tracking, daily challenges, leaderboards, and AI-generated plans. You can view the current pricing on the App Store or Google Play before subscribing.",
  },
  {
    question: "What challenges are available?",
    answer:
      "FunFit includes 7 challenge categories: Nutrition (sugar detox), Sleep (screen-free nights), Hydration (alcohol-free), Sport (workout routines), Sunshine (outdoor time), Stress (cold exposure), and Retention. Each has daily checklists, streak tracking, and XP rewards.",
  },
  {
