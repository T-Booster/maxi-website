...
export default function Mission() {
  return (
    <section className="py-24 md:py-32 bg-dark-surface relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <span className="inline-flex items-center px-4 py-2 rounded-full border border-dark-border text-sm text-dark-muted font-medium mb-8">
              Our Mission
            </span>
          ...
          >
            {stats.map((stat, i) => (
              <motion.div
                ...
                className="bg-dark border border-dark-border rounded-2xl p-6 text-center"
              >
