...
const stats = [
  ...
  },
  {
    icon: Heart,
    value: "5",
    label: "Health Pillars Tracked",
  },
  {
    icon: Shield,
    value: "USDA",
    label: "Verified Nutrition Data",
  },
  {
    icon: Users,
    value: "Global",
  ...
  return (
    <section className="py-20 relative bg-surface/50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="text-center p-6 rounded-2xl bg-surface border border-surface-border"
            >
        ...
        >
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-surface border border-surface-border">
